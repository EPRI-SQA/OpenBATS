...
import test_darts_forecast_v4gui as forecaster
...
#  Vis: extended pred_dates for the complete month of May 2021 
...
def simulate_from_gui(x_vars = None, y_var = None, 
                      start_date = None, end_date = None, train_val_split_date = None,
